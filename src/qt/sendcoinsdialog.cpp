...
void SendCoinsDialog::on_sendButton_clicked(){
    ...
    bool fAlwaysRequestUnlock = settings.value("fAlwaysRequestUnlock").toBool();
    ...
    if (encStatus == model->Locked || encStatus == model->UnlockedForStakingOnly || fAlwaysRequestUnlock) {
