...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        prcyico->setPixmap(QIcon(":icons/bitcoin").pixmap(130, 107));
...
{
    QDesktopServices::openUrl(QUrl("https://www.facebook.com/officialprcycoin/"));
}
...
{
    QDesktopServices::openUrl(QUrl("https://t.me/prcycoin"));
}
void BitcoinGUI::telegramLoungeActionClicked()
{
    QDesktopServices::openUrl(QUrl("https://t.me/PRCY_LOUNGE"));
}
void BitcoinGUI::mediumActionClicked()
{
    QDesktopServices::openUrl(QUrl("https://medium.com/PRCYcoin"));
}
...
{
    QDesktopServices::openUrl(QUrl("https://github.com/PRCYCoin/BootStrap/releases/tag/latest"));
}

void BitcoinGUI::openTGTechSupportClicked()
{
    QDesktopServices::openUrl(QUrl("https://t.me/PRCYTechSupport"));
}
